        ...
        <form class="modal-content pt-0"  id="editForm">
            ...
            <div class="modal-body flex-grow-1">
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control dt-full-name" id="fullname" placeholder="John Doe" name="fullname" />
                </div>
                <div class="mb-1">
                    <label class="form-label" for="basic-icon-default-code">Code</label>
                    <input type="text" id="code" class="form-control dt-code" placeholder="123456" name="code" />
                </div>
                <div class="mb-1">
