...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy;
            {{ date('Y') }}<a class="ms-25" href="http//:technogurudigitalsystems.com" target="_blank">Technoguru
                Ltd</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span
