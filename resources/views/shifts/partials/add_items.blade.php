        ...
        <tbody>
            ...
            @if (isset($shift))
                @foreach ($shift->items as $i => $item)
                    <tr>
                        <td>
                            <select name="user_id[]" id="user_id-{{$i+1}}" class="form-select">
                                @foreach ($users as $user)
                        ...
                        <td>
                            <input type="text" value="{{@$item->pump->name}}" class="form-control" readonly name="" id="">
                        </td>
                        <td>
                            <input type="text" value="{{@$item->status}}" class="form-control" readonly name="" id="">
                        </td>
                        {{-- <td><button type="button" class="btn btn-danger remove" id="remove"><i data-feather="trash"></i></button></td> --}}
